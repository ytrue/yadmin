...
public class ScheduleJobController {
    ...
    @PostMapping("/page")
    @ApiOperation("分页查询数据")
    public ApiResultResponse<IPage<ScheduleJob>> page(@RequestBody(required = false) QueryEntity<ScheduleJob> queryEntity) {

        IPage<ScheduleJob> page = scheduleJobService.paginate(queryEntity);
