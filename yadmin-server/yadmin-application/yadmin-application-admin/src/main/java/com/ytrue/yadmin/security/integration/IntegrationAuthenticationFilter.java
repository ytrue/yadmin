package com.ytrue.yadmin.security.integration;
...
public class IntegrationAuthenticationFilter extends GenericFilterBean implements ApplicationContextAware {
     ...
     * 登录类型参数名
     */
    private static final String AUTH_TYPE_PARAMETER_NAME = "auth_type";
    /**
     * 密码参数名
     */
     ...
     * 需要拦截的路由
     */
    private static final String OAUTH_TOKEN_URL = "/user/login";
    ...
    public void doFilter(
        ...
        if (requestMatcher.matches(request)) {
            ...
            //设置类型
            entity.setAuthType(requestParameterWrapper.getParameter(AUTH_TYPE_PARAMETER_NAME));
            //设置请求参数
