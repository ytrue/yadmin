...
import com.ytrue.yadmin.tools.log.event.SysLogEvent;
import com.ytrue.yadmin.tools.log.utils.SysLogUtils;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.ytrue.yadmin.tools.log.annotation.SysLog)")
