        ...
        <div>
            ...
            >
                <div slot="action" slot-scope="text, record">
                    <a-button
                            @click.stop.prevent="addOrUpdateHandle(record.categoryId)"
                            size="small"
...
<script>
    ...
    import {list,remove} from '@/services/mall/product/category'
        ...
        methods: {
            init() {
                list().then(response => {
                    ...
                    this.tabData = treeDataTranslate(menuData, "categoryId", "parentId")
                })
            },
