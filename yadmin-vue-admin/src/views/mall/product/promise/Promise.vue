        ...
        <div class="table-operator">
            ...
            <a-row class="row-item-search">
                <a-form class="search-form" :form="searchFrom" layout="inline">
                    <a-form-item label="承诺名称" refs="searchFromRefs">
                        <a-input placeholder="请输入承诺名称" v-decorator="['name']"/>
                    </a-form-item>
           ...
           <span slot="isDefault" slot-scope="record">
            ...
            <span slot="status" slot-scope="record">
              ...
              <a-button style="background-color: #108ee9;border-color:#108ee9" icon="edit" type="primary"
                        size="small" @click="addOrUpdateHandle(record.serviceId)">编辑
              </a-button>
...
<script>
    ...
    import {page, remove} from '@/services/mall/product/promise'
